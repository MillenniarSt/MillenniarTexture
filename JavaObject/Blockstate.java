...
public class Blockstate extends ComponentTx implements Serializable {
	...
	public boolean build(ArrayList<Object> elements) {
	    ...
	    ConsoleStage.defaultCns.printConsole(new ConsoleLine("BLOCKSTATE", "Build blockstate succefly", ConsoleLine.SUCCESS));
	    return true;
	}

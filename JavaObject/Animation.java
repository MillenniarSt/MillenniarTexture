...
public class Animation extends ComponentTx implements Serializable {
	...
	public boolean build(ArrayList<Object> elements) {
		...
		ConsoleStage.defaultCns.printConsole(new ConsoleLine("ANIMATION", "Build animation succefly", ConsoleLine.SUCCESS));
		return true;
	}

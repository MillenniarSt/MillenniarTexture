...
public class Model extends ComponentTx implements Serializable {
	...
	public boolean build(ArrayList<Object> elements) {
		...
		ConsoleStage.defaultCns.printConsole(new ConsoleLine("MODEL", "Build model succefly", ConsoleLine.SUCCESS));
		return true;
	}

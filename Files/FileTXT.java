...
public class FileTXT extends FileTx implements Initializable, ProgrammePath {
	...
	private String text;
	private SaveTXT savedTXT;
	
	public FileTXT(String path, SaveTXT savedTXT) {
		super(path, savedTXT, new ImageView(new Image(Main.getApl().getClass().getResourceAsStream("/resource/icon/tree_item/file_txt.png"))));
	...
	public FileTXT(String path, boolean activated) {
		super(path, "text", activated, new ImageView(new Image(Main.getApl().getClass().getResourceAsStream("/resource/icon/tree_item/file_txt.png"))));
		this.extension = "txt";
		this.savedTXT = new SaveTXT(this);
	}
	
	public FileTXT(String path, boolean activated, ArrayList<TextureObject> sources) {
		super(path, "text", activated, new ImageView(new Image(Main.getApl().getClass().getResourceAsStream("/resource/icon/tree_item/file_txt.png"))), sources);
		this.extension = "txt";
		this.savedTXT = new SaveTXT(this);
	}
	...
	public void open(ManagmentStage stage) {
		if(this.getTab() == null) {
			try {
				...
				FXMLLoader loader = new FXMLLoader(getClass().getResource("/Files/TabTXT.fxml"));
				loader.setController(this);
				this.setTab(loader.load());
				this.getTab().setText(this.getName());
				this.getTab().setGraphic(new ImageView(new Image(Main.getApl().getClass().getResourceAsStream("/resource/icon/tree_item/file_txt.png"))));

...
public class ComponentProperties<Value> implements Initializable {
	...
	@FXML
	private ToggleButton componentEditor;
	...
	private void buildRoot() {
		try {
			if(value instanceof Color) {
				FXMLLoader loader = new FXMLLoader(getClass().getResource("/Files/PropertiesComponentColor.fxml"));
				loader.setController(this);
				this.root = loader.load();
				checkKey();
			} else {
				FXMLLoader loader = new FXMLLoader(getClass().getResource("/Files/PropertiesComponent.fxml"));
				loader.setController(this);
				this.root = loader.load();
				checkKey();
				checkValue();
			...
			ConsoleStage.defaultCns.printConsole(new ConsoleLine("FILES", "Fail to load component's fxml from \"/Files/PropertiesComponent.fxml\" - IOException in FilePROPERTIES.components.load", ConsoleLine.ERROR, exc));
		}
	}

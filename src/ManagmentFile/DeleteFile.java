...
public class DeleteFile extends ManagmentFile {
    ...
    protected Integer[] call() throws Exception {
        ...
        if(file.exists()) {
            if(file.isDirectory()) {
                ConsoleStage.defaultCns.printConsole(new ConsoleLine("MANAGMENTFILE", "Deleteing files into a directory \"" + file.getPath() + "\"...", ConsoleLine.DEBUG));
                ...
                ConsoleStage.defaultCns.printConsole(new ConsoleLine("MANAGMENTFILE", "Deleteing file \"" + file.getPath() + "\"", ConsoleLine.DEBUG));

...
public class Component implements Serializable {
	...
	public Component(File file, String value) {
		this.file = file;
		if(value.contains(":")) {
	...
	public Component(File file, String derivation, String path) {
		this.file = file;
		if(derivation != null)
	...
	public boolean equals(Component component, String derivationDef) {
